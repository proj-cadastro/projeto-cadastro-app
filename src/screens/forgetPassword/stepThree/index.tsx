...
import { KeyboardAvoidingView, Platform, View, Image, Text, TextInput, ActivityIndicator, StyleSheet, TouchableWithoutFeedback, Keyboard } from "react-native";
                    ...
                    <Card style={[FormStyles.card, styles.card, { backgroundColor: theme.colors.background }]} mode="elevated">
                        <Card.Content>
                            <Image
                                ...
                                resizeMode="contain"
                            />
                            <Text style={[FormStyles.title, { color: theme.colors.onBackground }]}>Recuperar Senha</Text>
                            <Text style={[FormStyles.description, { color: theme.colors.onBackground }]}>Cadastre sua nova senha!</Text>
                            {fieldErrors.senha && (
                            ...
                            <View style={styles.passwordContainer}>
                                <TextInput
                                    ...
                                    style={[FormStyles.input, { flex: 1, color: theme.colors.onBackground, borderColor: theme.colors.outline }]}
                                    value={password}
                            ...
                            <Text style={{ color: theme.colors.onBackground }}>Confirmar Senha</Text>
                            <View style={styles.passwordContainer}>
                                <TextInput
